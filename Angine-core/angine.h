...
protected:
	...
	virtual void update() {} // 60 frame per sec
	virtual void tick() {} //1 per sec
	...
	void createWindow(int screenWidth, int screenHeight, std::string title, bool depth) {
		m_win = new Window(screenWidth, screenHeight, title.c_str(), depth);
